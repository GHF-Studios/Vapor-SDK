...
pub(super) enum PackagepackCommand {
    ...
    Select { packagepack_id: String, child_content_type: ContentType, child_content_id: String },
...
impl PackagepackCommand {
    pub(super) fn into_core(self) -> core::PackagepackCommand {
        match self {
            ...
            Self::New { packagepack_id } => author(core::SourceAuthoringCommand::New { content_id: packagepack_id }),
            Self::Init { packagepack_id } => author(core::SourceAuthoringCommand::Init { content_id: packagepack_id }),
            Self::Build { packagepack_id } => author(core::SourceAuthoringCommand::Build { content_id: packagepack_id }),
            Self::Package { packagepack_id } => author(core::SourceAuthoringCommand::Package { content_id: packagepack_id }),
            Self::Publish { packagepack_id } => author(core::SourceAuthoringCommand::Publish { content_id: packagepack_id }),
            Self::Add { packagepack_id, child_content_type, child_content_id } => compose(core::PackCompositionCommand::Add { pack_id: packagepack_id, child: child(child_content_type, child_content_id) }),
            Self::Remove { packagepack_id, child_content_type, child_content_id } => compose(core::PackCompositionCommand::Remove { pack_id: packagepack_id, child: child(child_content_type, child_content_id) }),
            Self::Select { packagepack_id, child_content_type, child_content_id } => compose(core::PackCompositionCommand::Select { pack_id: packagepack_id, child: child(child_content_type, child_content_id) }),
            Self::Unselect { packagepack_id, child_content_type, child_content_id } => compose(core::PackCompositionCommand::Unselect { pack_id: packagepack_id, child: child(child_content_type, child_content_id) }),
        }
    }
}
